...
> ##### __Este link realizará o download de um arquivo__ [StartAPIs.bat - Click para ver seu conteúdo](https://github.com/Moriblo/ObA/blob/main/StartAPIs.bat). __Todas as questões de segurança devem ser observadas!__
