...
> __Este link realizará o download de um arquivo [StartAPIs.bat - Click para ver seu conteúdo](https://github.com/Moriblo/ObA/blob/main/StartAPIs.bat)__ <span style="color: red;">Todas as questões de segurança devem ser observadas!</span>
